...
namespace Worldline.Connect.Sdk
{
    ...
    public class Communicator : IDisposable, ILoggingCapable, IObfuscationCapable
    {
        ...
        /// <summary>
        /// Releases all resource used by the <see cref="T:Worldline.Connect.Sdk.Communicator"/> object.
        /// </summary>
        /// <remarks>Call <see cref="Dispose"/> when you are finished using the
        /// <see cref="T:Worldline.Connect.Sdk.Communicator"/>. The <see cref="Dispose"/> method leaves the
        /// <see cref="T:Worldline.Connect.Sdk.Communicator"/> in an unusable state. After calling <see cref="Dispose"/>,
        /// you must release all references to the <see cref="T:Worldline.Connect.Sdk.Communicator"/> so the garbage
        /// collector can reclaim the memory that the <see cref="T:Worldline.Connect.Sdk.Communicator"/> was occupying.</remarks>
        public void Dispose()
        {
            Connection.Dispose();
        }
        ...
        /// <exception cref="CommunicationException"> when an exception occurred communicating with the Worldline Global Collect platform</exception>
        /// <exception cref="ResponseException">when an error response was received from the Worldline Global Collect platform</exception>
        ...
        internal MetadataProvider MetadataProvider { get; }
