...
namespace Worldline.Connect.Sdk.V1.Merchant.Captures
{
    ...
    public class CapturesClient : ApiResource
    {
        ...
        /// - <a href="https://apireference.connect.worldline-solutions.com/s2sapi/v1/en_US/dotnet/captures/disputes.html">Get disputes</a>
        /// </summary>
        /// <param name="captureId">string</param>
        /// <param name="context">CallContext</param>
        ...
        ///            or the service that you're trying to reach is temporary unavailable (HTTP status code 500, 502 or 503)</exception>
        /// <exception cref="ApiException">if the Worldline Global Collect platform returned any other error</exception>
        public async Task<DisputesResponse> Disputes(string captureId, CallContext context = null)
        {
            var pathContext = new Dictionary<string, string>
            {
                { "captureId", captureId }
            };
            var uri = InstantiateUri("/v1/{merchantId}/captures/{captureId}/disputes", pathContext);
            try
            {
        ...
        /// - <a href="https://apireference.connect.worldline-solutions.com/s2sapi/v1/en_US/dotnet/captures/dispute.html">Create dispute</a>
        /// </summary>
        /// <param name="captureId">string</param>
        ...
        ///            or the service that you're trying to reach is temporary unavailable (HTTP status code 500, 502 or 503)</exception>
        /// <exception cref="ApiException">if the Worldline Global Collect platform returned any other error</exception>
        public async Task<DisputeResponse> Dispute(string captureId, CreateDisputeRequest body, CallContext context = null)
        {
            var pathContext = new Dictionary<string, string>
            {
                { "captureId", captureId }
            };
            var uri = InstantiateUri("/v1/{merchantId}/captures/{captureId}/dispute", pathContext);
            try
            {
