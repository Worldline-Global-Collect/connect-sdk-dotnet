...
namespace Worldline.Connect.Sdk.Communication
{
    ...
    public class ResponseException : Exception
    {
        ...
        /// <summary>
        /// Gets the headers that were returned by the Worldline Global Collect platform.
        /// </summary>
        ...
        /// <summary>
        /// Returns a <see cref="T:System.String"/> that represents the current <see cref="T:Worldline.Connect.Sdk.Communication.ResponseException"/>.
        /// </summary>
        /// <returns>A <see cref="T:System.String"/> that represents the current <see cref="T:Worldline.Connect.Sdk.Communication.ResponseException"/>.</returns>
