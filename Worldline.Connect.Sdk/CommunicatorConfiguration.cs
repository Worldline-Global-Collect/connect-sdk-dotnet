...
namespace Worldline.Connect.Sdk
{
    ...
    public class CommunicatorConfiguration
    {
        ...
        /// <summary>
        /// Gets or sets the Worldline Global Collect platform API endpoint URI.
        /// </summary>
        ...
        /// For instance, for <see cref="AuthorizationType.V1HMAC"/> this is the identifier for the secret API key.
        /// </summary>
        public string AuthorizationId { get; set; }

        /// <summary>
        /// Gets or sets a secret used for authorization. The meaning of this secret is different for each authorization type.
        /// For instance, for <see cref="AuthorizationType.V1HMAC"/> this is the secret API key.
        /// </summary>
