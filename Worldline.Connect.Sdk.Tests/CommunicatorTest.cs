...
namespace Worldline.Connect.Sdk
{
    ...
    public class CommunicatorTest
    {
        ...
        public void TestToUriWithRequestParams()
        {
            ...
            Assert.That(uri, Is.EqualTo(new Uri("https://api.preprod.connect.worldline-solutions.com/v1/merchant/20000/convertamount?amount=123&source=USD&target=EUR&dummy=%C3%A9%26%25%3D")));
            Assert.That(uri2, Is.EqualTo(new Uri("https://api.preprod.connect.worldline-solutions.com/v1/merchant/20000/convertamount?amount=123&source=USD&target=EUR&dummy=%C3%A9%26%25%3D")));
        }
    }
}
